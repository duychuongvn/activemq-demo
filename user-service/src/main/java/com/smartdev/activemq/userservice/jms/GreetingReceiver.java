...
public class GreetingReceiver {
    ...
    @JmsListener(destination = "Consumer.userService.VirtualTopic.Greeting")
    public void receiveMessageFromVirtualTopic(String textMessage) {

        System.out.println(appName + ":: from Consumer.userService.VirtualTopic.Greeting: " + textMessage);
    }
